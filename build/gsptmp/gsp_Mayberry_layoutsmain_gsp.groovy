...
class gsp_Mayberry_layoutsmain_gsp extends org.grails.gsp.GroovyPage {
...
createTagBody(1, {->
printHtmlPart(6)
invokeTag('img','g',55,['dir':("images"),'file':("Mayberry_PRO.png"),'width':("200"),'height':("200")],-1)
printHtmlPart(7)
invokeTag('img','g',59,['dir':("images"),'file':("/stack/gitlab.svg"),'width':("20"),'height':("20")],-1)
printHtmlPart(8)
...
public static final long LAST_MODIFIED = 1600092129865L
